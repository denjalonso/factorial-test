...
both on-premise and embedded, so the high reusability of the components and the ease of integration 
with different services would be an important factor to consider.
